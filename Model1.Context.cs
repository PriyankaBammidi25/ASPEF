...
namespace ASPEF
{
    ...
    public partial class DemoEntities : DbContext
    {
        ...
        public virtual int sp_InsertEmp(Nullable<int> empno, string ename, string job, Nullable<int> mgr, Nullable<System.DateTime> hiredate, Nullable<int> sal, Nullable<int> comm, Nullable<int> deptno, ObjectParameter result)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_InsertEmp", empnoParameter, enameParameter, jobParameter, mgrParameter, hiredateParameter, salParameter, commParameter, deptnoParameter, result);
        }
    }
}
